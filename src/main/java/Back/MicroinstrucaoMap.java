...
public class MicroinstrucaoMap {
    ...
    static {
        ...
        mapa.put(28, "tir := lshift(ir); if n then goto 40;");
        ...
        mapa.put(65, "tir := lshift(ir); if n then goto 73;");
